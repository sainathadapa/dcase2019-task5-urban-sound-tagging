...
val_loader = DataLoader(valid_dataset, 48, shuffle=False)
train_loader_1 = DataLoader(train_dataset, 48, shuffle=True)
train_loader_2 = DataLoader(train_dataset, 48, shuffle=True)
